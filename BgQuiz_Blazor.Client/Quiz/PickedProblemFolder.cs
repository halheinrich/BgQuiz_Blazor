...
internal sealed class PickedProblemFolder
{
    ...
    /// <summary>Replace the pick with <paramref name="files"/> from <paramref name="folderName"/>.</summary>
    ...
    /// <summary>Clear the pick (Clear affordance, or after a failed read).</summary>
    public void Clear()
    {
        Files = [];
        FolderName = null;
