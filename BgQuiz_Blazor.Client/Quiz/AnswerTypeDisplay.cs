...
/// first, then the cube 2×2 walked doubler-major (no-double before double,
/// take before pass within each). It is the producer's ordering, so there is no
...
/// verdict's action labels and the weighted mix's wording respectively, and
/// neither is the home for corpus-composition vocabulary.
/// </para>
/// </summary>
internal static class AnswerTypeDisplay
{
    ...
    public static IReadOnlyList<Bucket> Buckets(AnswerTypeDistribution distribution)
    {
        ...
        [
            ...
            new Bucket("Too good to double", distribution.TooGood),
